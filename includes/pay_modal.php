...
<?php
  ...
  $total = 0;
	...
	$id2 = 1;
		...
		$nameAcid ;
		$conn2 = $pdo->open();
		$stmt2 = $conn2->prepare("SELECT * FROM `account` WHERE account_id =$id2");
		$stmt2->execute(['account_id '=>$id2]);
        ...
        <div class="modal-content">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="lastname" name="lastname" value=<?php echo $nameAc."-".$nameAcid ?>  disabled >
                    </div>
                </div>
                <div class="form-group">
